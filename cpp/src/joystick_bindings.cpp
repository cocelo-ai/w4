...
PYBIND11_MODULE(joystick, m) {
    ...
    // construct this class directly (it is produced by get_cmd()),
    ...
    // Bind Joystick class. Provide constructors, get_cmd and
    // is_connected methods. The get_cmd method returns a Python
